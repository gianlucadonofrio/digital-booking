...
const UserProvider = ({ children }) => {
  ...
  async function register(inputUser) {
    ...
    fetch(
      "https://api-digital-booking-pi.herokuapp.com/authenticate/newUser",
      requestOptions
    )
  ...
  async function login(inputUser) {
    ...
    fetch(
      "https://api-digital-booking-pi.herokuapp.com/authenticate/login",
      requestOptions
    )
      .then((response) => response.text())
      .then((result) => {
      ...
      fetch(`https://api-digital-booking-pi.herokuapp.com/users/isAdmin/${inputUser.username}`)
      .then(response => response.text())
      .then(result => {
