...
const MainReserve = () => {
  ...
  useState(() => {
    ...
    axios(
      "https://api-digital-booking-pi.herokuapp.com/booking/findAll"
    ).then((res) => {
  ...
  const { data, loading } = useFetch(
    `https://api-digital-booking-pi.herokuapp.com/products/find/${id}`
  );
  ...
  const bookingComplete = () => {
    if (selectTime) {
      fetch(
        "https://api-digital-booking-pi.herokuapp.com/booking/create",
        {
          method: "POST",
          headers: {
