...
const MainReserve = () => {
  ...
  useState(() => {
    ...
    // axios(
    //   "http://digitalbooking-api-env.eba-v2srmm4z.us-east-1.elasticbeanstalk.com/booking/findAll"
    // ).then((res) => {
  ...
  const { data, loading } = useFetch(
    `http://digitalbooking-api-env.eba-v2srmm4z.us-east-1.elasticbeanstalk.com/products/find/${id}`
  );
  ...
  const bookingComplete = () => {
    if (selectTime) {
      fetch(
        "http://digitalbooking-api-env.eba-v2srmm4z.us-east-1.elasticbeanstalk.com/booking/create",
        {
          method: "POST",
          headers: {
