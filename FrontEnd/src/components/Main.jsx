...
const Main = ({ getFavoritesLength }) => {
  ...
  const { data, loading } = useFetch(
    "http://digitalbooking-api-env.eba-v2srmm4z.us-east-1.elasticbeanstalk.com/products/findAll"
  );
  ...
  const fetchCategories = () => {
    axios
      .get(
        "http://digitalbooking-api-env.eba-v2srmm4z.us-east-1.elasticbeanstalk.com/categories/findAll"
      )
      .then((res) => {
  ...
  const fetchCities = () => {
    axios
      .get(
        "http://digitalbooking-api-env.eba-v2srmm4z.us-east-1.elasticbeanstalk.com/cities/findAll"
      )
      .then((res) => {
        setCities(res.data);
  ...
  const filtersSearchBlock = () => {
    ...
    if (datesSelected.length === 0 && city !== null) {
      fetch(
        `http://digitalbooking-api-env.eba-v2srmm4z.us-east-1.elasticbeanstalk.com/products/findByCity/${city.innerText}/${province.innerText}/${country.innerText}`
      )
        .then((res) => res.json())
        .then((data) => {
          if (data.length === 0) {
    ...
    if (datesSelected.length === 2 && city === null) {
      ...
      fetch(
        `http://digitalbooking-api-env.eba-v2srmm4z.us-east-1.elasticbeanstalk.com/products/findByDate/${startDate}/${endDate}`
      )
        .then((res) => res.json())
        .then((data) => {
          if (data.length === 0) {
    ...
    if (datesSelected.length === 2 && city !== null) {
      ...
      axios
        .get(
          `http://digitalbooking-api-env.eba-v2srmm4z.us-east-1.elasticbeanstalk.com/products/findByCityAndDate/${city.innerText}/${startDate}/${endDate}`
        )
        .then((res) => res.data)
        .then((data) => {
          if (data.length === 0) {
