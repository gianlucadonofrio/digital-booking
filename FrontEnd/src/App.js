      ...
      <UserProvider>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route
              path='/products/:id'
              element={<Product getFavoritesLength={getFavoritesLength} />}
            />
            <Route path='products/:id/reserve' element={<MainReserve />} />
            <Route path='*' element={<NotFoundPage />} />
            <Route
              path='/reservas'
              element={<ReservePage getFavoritesLength={getFavoritesLength} />}
            />
            <Route
              path='/favoritos'
              element={<WishList getFavoritesLength={getFavoritesLength} />}
            />
