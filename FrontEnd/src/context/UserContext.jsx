...
const UserProvider = ({ children }) => {
  ...
  async function register(inputUser) {
    ...
    fetch(
      "http://digitalbooking-api-env.eba-v2srmm4z.us-east-1.elasticbeanstalk.com/authenticate/newUser",
      requestOptions
    )
  ...
  async function login(inputUser) {
    ...
    fetch(
      "http://digitalbooking-api-env.eba-v2srmm4z.us-east-1.elasticbeanstalk.com/authenticate/login",
      requestOptions
    )
      .then((response) => response.text())
      .then((result) => {
      ...
      fetch(`http://digitalbooking-api-env.eba-v2srmm4z.us-east-1.elasticbeanstalk.com/users/isAdmin/${inputUser.username}`)
      .then(response => response.text())
      .then(result => {
